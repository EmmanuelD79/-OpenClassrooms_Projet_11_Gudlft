...
class TestIntegration:
    def test_should_login_and_logout_with_good_email(self, template_info):
        ...
        login_template, login_context, login_data  = template_info("post",
                                                                   "/showSummary", 
    ...
    def test_should_login_and_books_places(self, template_info):
        ...
        book_template, book_context, book_data  = template_info('get',
        ...
        purchase_template, purchase_context, purchase_data  = template_info("post",
                                                                            "/purchasePlaces", 
